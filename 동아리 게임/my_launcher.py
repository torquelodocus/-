...
# ------------------------------------------------------------------
## 게임 목록 설정
# 현재 파일 기준 상대경로로 games 폴더 지정
base_dir = os.path.dirname(os.path.abspath(__file__))
games_root = os.path.join(base_dir, "games")
game_files = [
...
BTN_COLOR = (245, 213, 102)      # 버튼 기본
BTN_HOVER = (80, 80, 80)      # 버튼 호버
...
def draw():
    # 배경 이미지 로드 및 표시
    try:
        bg_img = pygame.image.load(os.path.join(base_dir, "haha.png")).convert()
    ...
    # 타이틀
    title_surface = title_font.render("GAMES", True, TITLE_COLOR)
