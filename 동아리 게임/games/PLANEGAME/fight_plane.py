        ...
        if idx == 2:  # 게임 오버
            ...
            if tmr >= 117:
                ...
                def send_to_server(name):
                    try:
                        import socket
                        HOST = '여기다가 ipv4주소 써넣어 이 글 지우고'  # 서버 IP
                        PORT = 50007
                ...
                # 안내
                info = tk.Label(root, text="이름을 입력하세요:", font=("malgungothic", int(screen_height*0.03)), fg="#fff", bg="#1e1e1e")
